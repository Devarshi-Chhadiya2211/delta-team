  ...
  const handleBuyNow = async (productId) => {
    try {
      const response = await fetch("https://vistra-backend-1.onrender.com/cart", {
        ...
        body: JSON.stringify({
          productId: productId,
          // Add any other required data like quantity, user ID, etc.
        }),
      });
          ...
          <div class="categories">
            <div class="column">
              ...
              <ul>
                ...
                <li><span href="leaf.html">Leaf Visiting Cards</span> <span class="new-tag">NEW</span></li>
                <li><span href="oval.html">Oval Visiting Cards</span> <span class="new-tag">NEW</span></li>
                <li><span href="circle.html">Circle Visiting Cards</span> <span class="new-tag">NEW</span></li>
              </ul>
            </div>
            <div class="column">
              ...
              <ul>
                ...
                <li><span href="bulk.html">Bulk Visiting Cards</span> <span class="new-tag">NEW</span></li>
              </ul>
            </div>
            <div class="column">
            ...
            <div class="column">
              ...
              <ul>
                ...
                <li><span href="premium-metal.html">Premium Metal Card Holders</span> <span class="new-tag">NEW</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="main-container">
        <div class="image-section">
          ...
          <div class="content-overlay">
            ...
            <span href="shop-winterwear.html" class="cta-button">Shop Now</span>
          </div>
        </div>
        ...
        <div class="image-section">
          ...
          <div class="content-overlay">
            ...
            <div class="cta-buttons">
              <span href="calendars.html" class="cta-button">Calendars</span>
              <span href="notebooks.html" class="cta-button">Notebooks</span>
              <span href="diaries.html" class="cta-button">Diaries</span>
            </div>
          </div>
        </div>
      </div>

      <h1 class="section-heading">Explore All Categories</h1>
